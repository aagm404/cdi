...
/*
 * @SessionModel e' um Stereotype (esteriotipo) definido por mim, para as anotacoes @Named e @SessionScoped.
 * Ou seja, usar estas duas ultimas anotacoes e' a mesma coisa que usar a anotacao @SessionModel
 * 
 * @SessionModel = @Named + @SessionScoped
 * 
 */
